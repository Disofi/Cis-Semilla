...
if($grupo == '')
{
    $accion = 'insertarReporte';
}
else
{
    $accion = 'editarReporte';
    $datosTitulo = datosReporteTitulo($grupo);
    //print_r($datosTitulo);
...
<div class="content">
	<input name="accion" type="text" id="accion" value="<?php echo $accion;?>"/>
    <input name="grupo" type="text" id="grupo" value="<?php echo $grupo;?>"/>
    <input name="indice_temp" type="text" id="indice_temp" value="<?php echo $datosIndice[0];?>"/>
	...
	<div class="row col-md-12">
		<div class="row">
			...
			<div class="col-sm-3"><input name="titulo" type="text" id="titulo" value="<?php echo $datosTitulo[0];?>" maxlength="10" placeholder="M&aacute;ximo 10 caracteres" /></div>
		</div>
		<div class="row">
			...
			if (json.tipo == 'OK')
				{
					...
					setTimeout(function(){ $(location).attr('href', 'index.php?mod=mantenendor-reportes');}, 1000);	
				}
			else
				{
