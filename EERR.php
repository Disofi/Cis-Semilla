...
?>
<form name="estres" method="post" class="col-sm-12" id="estres" action="index.php?mod=EERR-ver">
<div class="content">
	...
	<h3 class="userForm col-sm-12 borde_gris2">Estados de Resultados</h3>
	...
	<div class="row col-md-12">
		...
		<div class="row">
			...
			<div class="col-sm-3">
				...
				<div class="row"style="border-style: solid;text-align:right;float:right;width:200px" >
		<br/>
			<div>
			<label class="col-sm-1" style="margin-left:40px;">Impuesto Actual:</label>
			</div>
	<div class="col-sm-1" style="margin-left:50px;">

	 <input type="text" id="impuesto" name="impuesto" value="<?php echo ValorImpuesto(); ?>" style="width:50px;background-color:width;">  </input>
		...
		<div class="row">
			<label class="col-sm-4">Acumulado *</label>
			<div class="col-sm-3">
				<input type="checkbox" value="1" id="acumulado" name="acumulado">
			</div>
		</div>
...
function valestres()
	...
	var impuesto = $.trim($('#impuesto').val());
	...
	if ($.trim(mesini) == '00')
		...
		{
		showMessage('div#mini-notification', '#mesfin', 'error', 'Estimado Usuario, Debe seleccionar un Mes de T�rmino, gracias.');
		return false;
		}
	else if ($.trim(ano) == '00')
		{
		showMessage('div#mini-notification', '#ano', 'error', 'Estimado Usuarios, Debe seleccionar el A�o de la consulta, gracias.');
		return false;
		}
	else
		{
